...
def create_flows(num_packets, payload_size, output_file, zipf_param, n_flows):
...
if __name__ == "__main__":
    ...
    parser.add_argument('--payload_size',  type=int, help='number of bytes per packet', required=True)
    parser.add_argument('--output',  help='name of output pcap file', required=True)

    args = parser.parse_args()

    create_flows(args.npackets, args.payload_size,
