...
def create_flows(num_flows, num_packets, payload_size, output_file):
...
if __name__ == "__main__":
    ...
    parser.add_argument('--payload_size',  help='payload_size', required=True)

    parser.add_argument('--output',  help='name of output pcap file', required=True)

    args = parser.parse_args()

    create_flows(args.nflows, args.npackets, args.payload_size, args.output)
